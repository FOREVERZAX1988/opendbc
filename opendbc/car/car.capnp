...
struct CarState {
  ...
  carNotReady @61 :Bool;  # car is transiently refusing engagement, used to prevent a fault if engaged (added for upstream compat, Macan: 恒False)
...
struct CarControl {
  ...
  struct HUDControl {
    ...
    activeCarrot @11: Int32;  # carrot man display flag (0/1)
    atcDistance @12: Float32;  # carrot man distance-to-turn presentation
